    ...
    <Container>
      ...
      <div className="dndnode not" onDragStart={(event) => onDragStart(event, 'not')} draggable>
        <svg width="39" height="33" viewBox="0 0 39 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M36 16C36 16.5304 35.7893 17.0391 35.4142 17.4142C35.0391 17.7893 34.5304 18 34 18C33.4696 18 32.9609 17.7893 32.5858 17.4142C32.2107 17.0391 32 16.5304 32 16C32 15.4696 32.2107 14.9609 32.5858 14.5858C32.9609 14.2107 33.4696 14 34 14C34.5304 14 35.0391 14.2107 35.4142 14.5858C35.7893 14.9609 36 15.4696 36 16Z" stroke-linecap="square"/>
